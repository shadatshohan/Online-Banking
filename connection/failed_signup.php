...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div style="width:700px" class="body">
      ...
      <p class='fail'>
        *Make sure to insert all field.<br>
        *Make sure to insert a valid E-mail and Phone Number. <br>
        *Make sure to insert password of 8-16 characters long. <br>
        *Make sure to insert correct informations.
      </p>
